...
<img src="../image/main.png" /><div id="logo"> 
 ...
 <ul>
   ...
   <li style=""><a href='<?php echo $logoutAction ?>'>logout</a></li>
...
<header> <div class="q" id="uno"> <a href="userr.php"><img src="../image/contract11.png" class="icon" /> </a>
  <p class="text"><a href="userr.php">User registration </a></p></div> 

<div class="q" id="dos"><a href="equi.php"><img src="../image/finance-and-business4.png" class="icon" /> </a>
  <p class="text"><a href="equi.php">Equipment Registration </a></p> </div>

<div class="q" id="tres"><a href="payment.php"><img src="../image/done2.png" class="icon" /> </a>
  <p class="text"><a href="pay.php"> Payment</a></p> </div>
<div class="q"id="custro"><a href="myembers.php"><img src="../image/drink70.png" " class="icon" /></a> 
  <p class="text"><a href="myembers.php">Manage Members</a></p> </div>
  ...
  <header1> <div class="b" id="c">
    ...
    <p class="text">Total costumers: <?php echo $totalRows_totalmembers ?></p>
  </div> 

<div class="b" id="d"> <img class="n" src="../image/finance-and-business5.png" width="130" height="135" />
<p class="text">Total Income:Rs 
<?php echo $row_amountsum['SUM( amount)']; ?>
   </p>
</div>
 
<div class="b" id="e"> <img class="n" src="../image/currency-symbol.png" width="512" height="512" />
<p class="text">Total Equipment Expenses:Rs <?php echo $row_Recordset1['SUM(amount)']; ?> </p>
</div>
<div class="b" id="f"><img class="n" src="../image/deadlines.png" width="512" height="512" />  <p class="text">DATE:  <?php $datenow=date("l, d F Y");  
