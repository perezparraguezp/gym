...
<img src="../image/main.png" /><div id="logo"> 
 ...
 <ul>
  ...
  <div id="content">
    ...
    <div id="c1"><span class="txtuserreg"> <img src="../image/office.png" width="74" height="76" alt="us" />Members Payment:</span></div>
...
<p> 
      <form action="" id="form2" method="post" name="form2">
        <table width="570" border="0" align="center" cellpadding="4" cellspacing="2">
          <tr>
            <td width="150" height="20" bgcolor="#2F6F2E">userid</td>
            <td width="174" bgcolor="#2F6F2E">firstname</td>
            <td width="170" bgcolor="#2F6F2E">lastname</td>
          ...
          <?php do { ?>
            <tr>
              ...
              <td class="kk"> <p>
              <a href="userpay.php?userid=<?php echo $row_Recordset1['userid']; ?>" class="abc">MakePayment</a></p>
              </td>
            </tr>
        ...
        <table border="0">
          <tr>
            <td><?php if ($pageNum_Recordset1 > 0) { // Show if not first page ?>
                <a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, 0, $queryString_Recordset1); ?>" class="kk">First</a>
                ||
            ...
            <td><?php if ($pageNum_Recordset1 < $totalPages_Recordset1) { // Show if not last page ?>
                <a href="<?php printf("%s?pageNum_Recordset1=%d%s", $currentPage, $totalPages_Recordset1, $queryString_Recordset1); ?>" class="kk">Last</a>
                <?php } // Show if not last page ?></td>
          </tr>
        </table>
